...
urlpatterns = [
    ...
    url(r'^document/auditor/create/(?P<instance_id>[0-9]+)$', views.document_auditor_create, name='document_auditor_create'),
    url(r'^sync/$', views.user_calendar_sync, name="sync"),
    url(r'^oauth2callback/$', views.auth_return, name="oauth_callback"),
    url(r'sync/audit/(?P<audit_id>[0-9]+)$', views.create_event_calendar, name="sync_calendar")
]
